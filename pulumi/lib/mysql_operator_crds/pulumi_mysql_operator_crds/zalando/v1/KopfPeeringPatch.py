...
__all__ = ['KopfPeeringPatchArgs', 'KopfPeeringPatch']
...
@pulumi.type_token("kubernetes:zalando.org/v1:KopfPeeringPatch")
class KopfPeeringPatch(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[KopfPeeringPatchArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Patch resources are used to modify existing Kubernetes resources by using
        Server-Side Apply updates. The name of the resource must be specified, but all other properties are optional. More than
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KopfPeeringPatchArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = KopfPeeringPatchArgs.__new__(KopfPeeringPatchArgs)

            __props__.__dict__["api_version"] = 'zalando.org/v1'
            __props__.__dict__["kind"] = 'KopfPeering'
            __props__.__dict__["metadata"] = metadata
            __props__.__dict__["status"] = None
        super(KopfPeeringPatch, __self__).__init__(
            'kubernetes:zalando.org/v1:KopfPeeringPatch',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'KopfPeeringPatch':
        """
        Get an existing KopfPeeringPatch resource's state with the given name, id, and optional extra
        ...
        __props__.__dict__["status"] = None
        return KopfPeeringPatch(resource_name, opts=opts, __props__=__props__)
