...
__all__ = ['MySQLBackupInitArgs', 'MySQLBackup']

@pulumi.input_type
class MySQLBackupInitArgs:
...
@pulumi.type_token("kubernetes:mysql.oracle.com/v2:MySQLBackup")
class MySQLBackup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 spec: Optional[pulumi.Input[Union['MySQLBackupSpecArgs', 'MySQLBackupSpecArgsDict']]] = None,
                 __props__=None):
        """
        Create a MySQLBackup resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[MySQLBackupInitArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a MySQLBackup resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param MySQLBackupInitArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MySQLBackupInitArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MySQLBackupInitArgs.__new__(MySQLBackupInitArgs)
        ...
        super(MySQLBackup, __self__).__init__(
            'kubernetes:mysql.oracle.com/v2:MySQLBackup',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'MySQLBackup':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Output['outputs.MySQLBackupSpec']:
        return pulumi.get(self, "spec")

    @_builtins.property
    @pulumi.getter
    def status(self) -> pulumi.Output[Optional['outputs.MySQLBackupStatus']]:
